...
@DynamicInsert
@DynamicUpdate
@Table(name = "BASE_BANK_DETAILS", indexes = { @Index(columnList = "partner"), @Index(columnList = "bank"), @Index(columnList = "bank_address"), @Index(columnList = "currency"), @Index(columnList = "fullName"), @Index(columnList = "code"), @Index(columnList = "company") })
