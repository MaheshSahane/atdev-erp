...
@Track(on = TrackEvent.UPDATE, fields = { @TrackField(name = "code"), @TrackField(name = "company"), @TrackField(name = "sequenceTypeSelect"), @TrackField(name = "padding"), @TrackField(name = "toBeAdded"), @TrackField(name = "prefixe"), @TrackField(name = "suffixe"), @TrackField(name = "yearlyResetOk"), @TrackField(name = "monthlyResetOk") })
